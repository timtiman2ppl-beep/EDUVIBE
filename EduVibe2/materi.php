...
<div class="container">
    ...
    <div style="text-align: center;">
        <h3>Sudah Paham Materinya?</h3>
        <p>Pilih mode pengujian di bawah ini untuk menguji kemampuanmu!</p>
        
        <div class="menu-grid">
            <a href="game.php">
                <button type="button" class="btn-menu">🎮 Main Game</button>
            </a>

            <a href="kuis.php">
                <button type="button" class="btn-menu">🧠 Ikuti Kuis</button>
            </a>

            <a href="praktek.php">
                <button type="button" class="btn-menu">💻 Live Praktek</button>
            </a>
        </div>
    </div>
</div>
